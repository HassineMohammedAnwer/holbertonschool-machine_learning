...
class WGAN_GP(keras.Model):
    ...
    def replace_weight(self, gen_h5, disc_h5):
        """replace the weights of the generator
        __by the ones that have been stored in the .h5 file gen_h5
        replace the weights of the discriminator by the ones that
        __have been stored in the .h5 file gen_h5
        """
